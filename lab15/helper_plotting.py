...
def plot_images_sampled_from_vae(model, device, latent_size, unnormalizer=None, num_images=10):
    ...
    with torch.no_grad():
        ...
        rand_featuresDict=[None,None,None,None,None,None,None,None,None,None]
        for i in range(10):
            rand_featuresDict[i] = torch.tensor([torch.normal(mean=-0.9, std=torch.tensor([0.1])), torch.normal(mean=0, std=torch.tensor([0.1]))])
        rand_features = torch.stack((rand_featuresDict[0],rand_featuresDict[1],rand_featuresDict[2],rand_featuresDict[3],rand_featuresDict[4],rand_featuresDict[5],rand_featuresDict[6],rand_featuresDict[7],rand_featuresDict[8],rand_featuresDict[9])).to(device)       
